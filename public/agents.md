...
Open https://joaovitorspereira.github.io/portfolioweb/en in a WebMCP-capable browser. These read-only tools are registered on `document.modelContext`:
...
## Static files
- https://joaovitorspereira.github.io/portfolioweb/resume.json (JSON Resume, EN) and /resume.pt.json (PT)
- https://joaovitorspereira.github.io/portfolioweb/llms.txt and /llms-full.txt
