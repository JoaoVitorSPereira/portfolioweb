export const projects = [
  ...
  {
    title: 'Alura - ReactJS Front-end Course ',
    description:
...
export const TimeLineData = [
  {
    year: 2018,
    text: 'My brother influenced me to study HTML, CSS and Javascript.',
    textPT: 'Meu irmão me influenciou a estudar HTML, CSS e Javascript.',
  },
  {
    year: 2019,
    text: 'Worked as a freelance developer, and started studying in a college',
    textPT:
      'Trabalhei como desenvolvedor freelance e comecei a estudar em uma faculdade',
  },
  {
    year: 2020,
    text: 'Got my first job as a Front-End developer.',
    textPT: 'Consegui meu primeiro emprego como desenvolvedor Front-End.',
  },
  {
    year: 2021,
    text: 'Working hard and studying while developing a career.',
    textPT: 'Trabalhar muito e estudar enquanto desenvolve uma carreira.',
  },
];
